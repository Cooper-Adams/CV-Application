const Section_Head = (props) => {
    const toggleSection = (e) => {
        if (e.target.firstChild.style.transform == 'rotate(270deg)' || (e.target.firstChild.style.transform == '' && props.section_title == 'Personal Information')) {
            e.target.firstChild.style.transform = 'rotate(90deg)'
        } else { e.target.firstChild.style.transform = 'rotate(270deg)'}

        if (e.target.parentNode.parentNode.parentNode.classList.contains('pi')) {
            if (e.target.parentNode.parentNode.parentNode.style.maxHeight == '' || e.target.parentNode.parentNode.parentNode.style.maxHeight == '871px') {
                e.target.parentNode.parentNode.parentNode.style.maxHeight = '0'
            } else {
                e.target.parentNode.parentNode.parentNode.style.maxHeight = '871px'
            }
        } else if (e.target.parentNode.parentNode.parentNode.style.maxHeight) {
