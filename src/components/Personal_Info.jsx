...
const Personal_Info = (props) => {
  const toggleSection = (e) => {
    ...
    if (e.target.parentNode.parentNode.style.maxHeight) {
      ...
      e.target.parentNode.parentNode.style.maxHeight = e.target.parentNode.parentNode.scrollHeight + 'px'
    }
  }
